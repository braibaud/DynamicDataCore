...
namespace DynamicDataCore
{
    public class ImageUtils
    {
        public static string WebBase64EncodeImageByteArrayOrNull(byte[] image)
        {
            ...
            Dictionary<byte[], string> byteSignaturesAndContentTypes = new Dictionary<byte[], string>();
            ...
            KeyValuePair<byte[], string>? matchingSig = byteSignaturesAndContentTypes
            ...
            string imageString = $"data:{matchingSig.Value.Value};base64," + Convert.ToBase64String(image);
